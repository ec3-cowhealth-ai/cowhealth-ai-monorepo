...
router.post("/",      requireAuth, requirePermission("Create PermissionGroup"),  validateSchema(createPermissionGroupSchema), storePermissionGroup);
router.put("/:id",    requireAuth, requirePermission("Update PermissionGroup"),  validateSchema(updatePermissionGroupSchema), updatePermissionGroupController);
...
router.post("/:id/grant",  requireAuth, requirePermission("Update PermissionGroup"), validateSchema(grantRevokeSchema), grantPermissions);
router.post("/:id/revoke", requireAuth, requirePermission("Update PermissionGroup"), validateSchema(grantRevokeSchema), revokePermissions);
