...
router.post("/:id/permissions",                   requireAuth, requirePermission("Update PermissionGroup"), addPermission);
router.delete("/:id/permissions/:permissionId",   requireAuth, requirePermission("Update PermissionGroup"), removePermission);
