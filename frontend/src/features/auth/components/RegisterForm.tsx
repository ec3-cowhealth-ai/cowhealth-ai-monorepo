  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--s-4)' }}>
      <div className="form-field">
        <label className="form-field__label" htmlFor="name">Nome completo</label>
        <input
          id="name"
          type="text"
      ...
      <div className="form-field">
        <label className="form-field__label" htmlFor="confirmPassword">Confirmar senha</label>
        <input
          id="confirmPassword"
          type="password"
          className="form-field__input"
        ...
        />
        {errors.confirmPassword && <p className="form-field__error">{errors.confirmPassword.message}</p>}
      </div>
