...
const menuItems: { icon: ReactNode; label: string; path: string }[] = [
  {
    icon: <List size={18} color="var(--text-secondary)" />,
    label: "Rebanho",
    path: "/cows",
  },
  {
    icon: <Warehouse size={18} color="var(--text-secondary)" />,
    label: "Fazendas",
    path: "/farms",
  },
  {
    icon: <Tag size={18} color="var(--text-secondary)" />,
    label: "Coleiras",
    path: "/collars",
  },
  {
    icon: <User size={18} color="var(--text-secondary)" />,
    label: "Usuários",
    path: "/access/users",
  },
];
