    ...
    <div style={{ background: C.bg, minHeight: "100%" }}>
      <div style={{ padding: "24px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ ...cardStyle, display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <p style={{ margin: 0, fontWeight: 700, fontSize: 16, color: C.text }}>{user?.name ?? "—"}</p>
            <p style={{ margin: "2px 0 0 0", fontSize: 12, color: C.muted }}>{user?.email ?? "—"}</p>
            <span style={{
              display: "inline-block", marginTop: 6, fontSize: 10, fontWeight: 700,
              padding: "2px 10px", borderRadius: 999, background: "#e6f1ea", color: C.green,
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", color: C.red, width: "100%",
          }}
        >
